...
where c.Firstname=ca.FirstName and c.LastName=ca.lastName and ca.city='Kurukshetra';
--persons in a particular state
select c.*,ca.city,ca.state,ca.zip
from contact c,contact_address ca
where c.Firstname=ca.FirstName and c.LastName=ca.lastName and ca.state='Haryana';
